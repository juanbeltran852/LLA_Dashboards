...
acct_panel_mortal as (
select 
-- accountno,
serviceno,
max(first_bill_created_dt) as max_oldest_unpaid_bill_dt,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '0' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '1' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '0' month) then 1 else null end) as mort_M0,
...
max(case when month_survival = (SELECT input_month FROM parameters) + interval '1' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '2' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '1' month) then 1 else null end) as mort_M1,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '2' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '3' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '2' month) then 1 else null end) as mort_M2,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '3' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '4' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '3' month) then 1 else null end) as mort_M3,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '4' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '5' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '4' month) then 1 else null end) as mort_M4,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '5' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '6' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '5' month) then 1 else null end) as mort_M5,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '6' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '7' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '6' month) then 1 else null end) as mort_M6,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '7' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '8' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '7' month) then 1 else null end) as mort_M7,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '8' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '9' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '8' month) then 1 else null end) as mort_M8,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '9' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '10' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '9' month) then 1 else null end) as mort_M9,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '10' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '11' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '10' month) then 1 else null end) as mort_M10,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '11' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '12' month - interval '1' day) or cast(serviceno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) = (SELECT input_month FROM parameters) + interval '11' month) then 1 else null end) as mort_M11,
max(case when month_survival = (SELECT input_month FROM parameters) + interval '12' month and cast(serviceno as varchar) not in (SELECT serviceno FROM "db-analytics-prod"."tbl_postpaid_cwp" WHERE account_status in ('ACTIVE','RESTRICTED', 'GROSS_ADDS') and category in ('Consumer', 'Consumer Mas Control','Low Risk Consumer', 'CW Employees') and date(dt) = (SELECT input_month FROM parameters) + interval '13' month - interval '1' day) or cast(accountno as varchar) in (SELECT cast(act_acct_cd as varchar) FROM "lla_cco_int_ext_dev"."drc_movil_new" WHERE date(concat(drc_period_final, '-01')) between (SELECT input_month FROM parameters) + interval '10' month and (SELECT input_month FROM parameters) + interval '12' month) then 1 else null end) as mort_M12
from forward_months 
group by 
    -- accountno
    serviceno
