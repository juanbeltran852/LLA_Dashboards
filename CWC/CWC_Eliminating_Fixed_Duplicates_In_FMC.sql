...
--     case 
--         when num_row > 1 finalmobilechurnFlag is not null then 'Mobile Churner'
...
--     else partial_total_churnflag end as partial_total_churnflag,
    ...
    -- case 
    --     when num_row > 1 and mobilechurntenuresegment = 'Early-life' then 'Early tenure'
    --     when num_row > 1 and mobilechurntenuresegment = 'Mid-life' then 'Mid tenure'
    --     when num_row > 1 and mobilechurntenuresegment = 'Late-life' then 'Late tenure'
...
SELECT
    -- *
    distinct mobilechurntenuresegment
FROM "dg-sandbox"."cwc_fmc_feb2023"
WHERE 
