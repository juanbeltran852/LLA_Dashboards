...
SELECT  subsrptn_id AS account
        ...
        ,DATE_DIFF('day',date(activation_dt),(date(dt_2) + interval '1' month - interval '1' day)) AS mob_b_mes_TenureDays
...
FROM cust_mstr_adj
WHERE date(dt_2) = (SELECT input_month FROM parameters) - interval '1' month
