...
WHERE 
    ...
    and acct_type = 'R'
    -- and ord_typ = 'V_DISCO' and disco_rsn_sbb != 'VL'
    and ord_typ = 'NON PAY'
)
...
FROM final_join
WHERE
    fix_s_fla_mainmovement = '6.Null last day' -- and fix_s_fla_churntype = '2. Fixed Involuntary Churner'
    -- b_id is not null and 
    -- fix_s_att_account is null -- and first_dt is null
    -- and account_id is null
    and 
    account_id in (SELECT account_id FROM accounts_of_analysis)
ORDER BY random(*)
LIMIT 10
...
--     -- and (first_order_type = 'V_DISCO' or last_order_type = 'V_DISCO')
--     -- and ord_typ = 'V_DISCO' and disco_rsn_sbb != 'VL'
-- ORDER BY random(*)
-- LIMIT 10
